...
public class VerificationCodeUtils {
    private static VerificationCodeUtils mCodeUtils;
    ...
    public static VerificationCodeUtils getInstance() {
        if (mCodeUtils == null) {
            mCodeUtils = new VerificationCodeUtils();
        }
        return mCodeUtils;
    }
    ...
    //生成验证码图片
    public void createBitmap(final String code, final ICreatCode iCreatCode) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                canvas.restore();
                iCreatCode.onFinish(code, bitmap);
            }
        }).start();
    }


    public interface ICreatCode {
        void onFinish(String code, Bitmap bitmap);
    }
    //生成干扰线
