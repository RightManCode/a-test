...
public class EditTransactionRecordTimeActivity extends BaseStyleActivity {
    ...
    private int[] mIconUnselectIds = {
            R.drawable.tr1_unselect,
            R.drawable.tr2_unselect,
            R.drawable.tr3_unselect,
            R.drawable.tr4_unselect,
    };
    private int[] mIconSelectIds = {
            R.drawable.tr1_select,
            R.drawable.tr2_select,
            R.drawable.tr3_select,
            R.drawable.tr4_select,
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_transaction_record_time, R.layout.base_toolbar_back);
...
//                        .setMaxMillseconds(System.currentTimeMillis())
            ...
            case R.id.btn_start_search:
                ...
                Intent intent = new Intent(this, TransactionRecordActivtiy.class);
