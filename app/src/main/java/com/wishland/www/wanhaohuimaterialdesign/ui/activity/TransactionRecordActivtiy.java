...
public class TransactionRecordActivtiy extends BaseStyleActivity {
    @BindView(R.id.rec)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transaction_record_activtiy, R.layout.base_toolbar_back);
...
//                for (GlobalData.TradeSubTypeBean tradeSubTypeBean :
//                        GlobalHandler.getGlobaldata().getTradeSubType()) {
//                    if (item.getType()==tradeSubTypeBean.getId()){
//
//                    }
//                }
                        ...
                        try {
                            ...
                            if (jsonObject.getInt("queryid") > 0) {
                                ...
                                if (!TextUtils.isEmpty(commonList) && TextUtils.isEmpty(otherList)) {
                                    ...
                                    setTitle("交易记录（共" + records.size() + "条）");
