...
public class ReEditTransPwActivity extends BaseStyleActivity {
        ...
        OkGo.post(Api.REEDIT_TRANS_PW)
                ...
                .execute(new AbsCallbackPro() {
                    ...
                    public void onBefore(BaseRequest request) {
                        ...
                        materialDialog = new MaterialDialog.Builder(ReEditTransPwActivity.this)
                                .title("修改中")
                                .content("修改操作中,请稍后.....")
                                .progress(true, 0)
                                .show();
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        if (isSuccess != null && isSuccess.getStatus()) {
                            Toast.makeText(ReEditTransPwActivity.this, "修改成功", Toast.LENGTH_SHORT).show();
