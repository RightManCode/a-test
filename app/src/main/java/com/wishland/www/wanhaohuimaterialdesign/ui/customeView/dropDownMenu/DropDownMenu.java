package com.wishland.www.wanhaohuimaterialdesign.ui.customeView.dropDownMenu;
...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        dividerColor = a.getColor(com.yyydjk.library.R.styleable.DropDownMenu_dddividerColor, dividerColor);
        textSelectedColor = a.getColor(com.yyydjk.library.R.styleable.DropDownMenu_ddtextSelectedColor, textSelectedColor);
        textUnselectedColor = a.getColor(com.yyydjk.library.R.styleable.DropDownMenu_ddtextUnselectedColor, textUnselectedColor);
        menuBackgroundColor = a.getColor(com.yyydjk.library.R.styleable.DropDownMenu_ddmenuBackgroundColor, menuBackgroundColor);
        maskColor = a.getColor(com.yyydjk.library.R.styleable.DropDownMenu_ddmaskColor, maskColor);
    ...
    public void closeMenu() {
        if (current_tab_position != -1) {
            ...
            popupMenuViews.setAnimation(AnimationUtils.loadAnimation(getContext(), com.yyydjk.library.R.anim.dd_menu_out));
            maskView.setVisibility(GONE);
            maskView.setAnimation(AnimationUtils.loadAnimation(getContext(), com.yyydjk.library.R.anim.dd_mask_out));
            ...
            if (target == tabMenuView.getChildAt(i)) {
                if (current_tab_position == i) {
                    ...
                    if (current_tab_position == -1) {
                        ...
                        popupMenuViews.setAnimation(AnimationUtils.loadAnimation(getContext(), com.yyydjk.library.R.anim.dd_menu_in));
                        maskView.setVisibility(VISIBLE);
                        maskView.setAnimation(AnimationUtils.loadAnimation(getContext(), com.yyydjk.library.R.anim.dd_mask_in));
